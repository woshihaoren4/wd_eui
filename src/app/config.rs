    ...
    fn show(&mut self, _ctx: &Context, ui: &mut Ui) {
        egui::Grid::new("config")
            ...
            .show(ui,|ui|{
                ...
                ui.add(TextEdit::singleline(&mut cfg.http_url).hint_text("rust-grpc-proxy address"));
                ui.end_row();
                ...
                ui.horizontal(|ui|{
                    ui.add(TextEdit::singleline(&mut cfg.node_code).desired_width(150.0).hint_text("rust-grpc-proxy address"));
